[]{#SystemDictionary_002dcommand_002dline}

::: header
Next:
[SystemDictionary-miscellaneous](SystemDictionary_002dmiscellaneous.html#SystemDictionary_002dmiscellaneous){accesskey="n"
rel="next"}, Previous: [SystemDictionary-c
call-outs](SystemDictionary_002dc-call_002douts.html#SystemDictionary_002dc-call_002douts){accesskey="p"
rel="prev"}, Up:
...
[]{#SystemDictionary_003a-command_002dline}

#### 1.161.5 SystemDictionary: command-line {#systemdictionary-command-line .subsection}

[]{#index-arguments_003ado_003a}
[]{#index-arguments_003ado_003aifError_003a-1}
...
file names (or in general, other command-line arguments than options)
the block's first argument will be nil. For options without arguments,
or with unspecified optional arguments, the block's second argument will
be nil. The option name will be passed as a character object for short
options, and as a string for long options.

If an error is found, nil is returned. For more information on the
syntax of pattern, see #arguments:do:ifError:.

[]{#index-arguments_003ado_003aifError_003a}
